"""
Extension Step 4 — LOO Training for DAGClassifier (DAGNN) — ARCHIVED
======================================================================
This is the original Leave-One-Out cross-validation training script.
Superseded by extension/step4/train_dag_classifier.py (train/val/test split).

Kept for reference and reproducibility of the LOO results reported in §4.5.
LOO results (sim_threshold=0.30, 50 epochs): AUC=0.7125±0.1303, F1=0.5758±0.2559
...
def main():
    parser = argparse.ArgumentParser(description="LOO training for DAGNN classifier (B4) — archived")
